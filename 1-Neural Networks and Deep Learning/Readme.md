...
- Basically a single neuron will calculate weighted sum of input(**W.T*X**) and then we can set a threshold to predict output in a perceptron. If weighted sum of input **cross the threshold, perceptron fires--1** and **if not--0** then perceptron doesn't predict.
...
- Different types of neural networks for supervised learning which includes:
  ...
  - **RNN** or Recurrent neural networks (Useful in **Sequencial** tasks, **Speech recognition or NLP**)
  - **Standard NN** (Useful for **Structured data** in Regression)
  - **Hybrid/custom NN** or a Collection of NNs types (Useful in **Multimodal** tasks, like Autonomous Driving)
